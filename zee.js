    ...
    var savedDiceTotal = 0;
        $('body').on('click', '.roll', function(){
            if(rollNumber < 3){
                ...
                var ones = totalDiceArr.filter(totalDiceArr => totalDiceArr == 1).reduce((acc, val) => acc + val, 0);
                var twos = totalDiceArr.filter(totalDiceArr => totalDiceArr == 2).reduce((acc, val) => acc + val, 0);
                var threes = totalDiceArr.filter(totalDiceArr => totalDiceArr == 3).reduce((acc, val) => acc + val, 0);
                var fours = totalDiceArr.filter(totalDiceArr => totalDiceArr == 4).reduce((acc, val) => acc + val, 0);
                var fives = totalDiceArr.filter(totalDiceArr => totalDiceArr == 5).reduce((acc, val) => acc + val, 0);
                var sixes = totalDiceArr.filter(totalDiceArr => totalDiceArr == 6).reduce((acc, val) => acc + val, 0);
                ...
                $(".dice-total .dice-total-number").text(totalDiceArr.reduce((acc, val) => acc + val, 0))
            } 
